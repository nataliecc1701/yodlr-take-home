...
Once the server is running, you can run the front end by opening another shell to the vite-react-yodlr folder and running
```
npm run dev
```

This will start the front end on [http://localhost:5173](http://localhost:5173)
